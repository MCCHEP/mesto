...
export const avatarFormCaller = document.querySelector('.profile__edit-avatar-button');
export const avatarEditForm = document.querySelector('.form_type_edit-avatar');
